          ...
          <Alert
            ...
            description={
              <div>
                ...
                <div><b>Holidays</b>: {summary.holidays.exists ? `${summary.holidays.from} → ${summary.holidays.to} (${summary.holidays.days} days, ${summary.holidays.keys} regiona)` : 'no data'}</div>
              </div>
            }
          />
        )}
